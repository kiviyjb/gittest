...
public class FreePatchUtil  {  
    ...
    public static String patchFile="C:/Users/guxin/Desktop/patch.txt";//补丁文件,由eclipse svn plugin生成  
      
    public static String projectPath="D:/newworkspace/xgr";//项目文件夹路径  
      
    public static String webContent="webapp";//web应用文件夹名  
      
    public static String classPath="D:/newworkspace/xgr/target/build";//class存放路径  
      
    public static String desPath="C:/Users/guxin/Desktop/update_pkg";//补丁文件包存放路径  
      
    public static String version="20170921";//补丁版本  
